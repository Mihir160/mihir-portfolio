            ...
            <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
              <div className="max-w-xl mb-6">
                ...
                <p className="text-base  md:text-lg">
                  Tech exchange is a website for buying old mobiles. Buyers can
                  buy old mobiles through this website. the first home page has
                  3 categories, if you click on the category button we can see
                  the category products.
                </p>
              </div>
              <div className="flex gap-4">
                <a href="https://used-products-resale-45da8.web.app/">
                  <FaLaptop className="text-2xl"></FaLaptop>
                </a>
                <a href="https://github.com/Mihir160/b612-used-products-resale-clients-side">
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
              <div className="max-w-xl mb-6">
                <h2 className="max-w-lg text-[#00df9a] mb-6 font-sans text-3xl font-bold tracking-tight  sm:text-4xl sm:leading-none">
                  XtreameClean
                  <br className="hidden md:block" />A personal cleaning{" "}
                  <span className="inline-block text-deep-purple-accent-400">
                    service website
                  </span>
                </h2>
                <p className="text-base  md:text-lg">
                  House office and other cleaning service websites. When we go
                  to the home page, we see only three services. If we click to
                  see all then we will get all services.
                </p>
              </div>
              <div className="flex gap-4">
                <a href="https://b6a11-service-review.web.app/">
                  <FaLaptop className="text-2xl"></FaLaptop>
                </a>
                <a href="https://github.com/Mihir160/b6a11-service-review-client-side">
                  <FaGithub className="text-2xl"></FaGithub>
                </a>
              </div>
            </div>
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
              <div className="max-w-xl mb-6">
                ...
                <p className="text-base  md:text-lg">
                  We can purchase different types of courses through this
                  website. If we click course then it will show how many courses
                  there are. Now if you click on the course names on the left
                  side, the course detail will go. If we get to the end of the
                  course cards If you click the button, you will go to the
                  details button.
                </p>
              </div>
              <div className="flex gap-4">
                <a href="https://code-stack-1a5a8.web.app/">
                  <FaLaptop className="text-2xl"></FaLaptop>
                </a>
                <a href="https://github.com/Mihir160/b610-learning-platform-client-side">
                  <FaGithub className="text-2xl"></FaGithub>
                </a>
              </div>
            </div>
