            ...
            <div className='lg:mx-28'>
                <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    ...
                    <div className="relative mt-4 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div className="flex text-center shadow-[#00df9a] flex-col justify-between overflow-hidden  transition-shadow duration-200  rounded shadow-xl group hover:shadow-2xl">
                            <img src={css} alt="" srcset="" />
                            <h1 className='text-2xl font-bold mb-2'>CSS</h1>
                        </div>
                        <div className="flex flex-col justify-between shadow-[#00df9a] text-center overflow-hidden  transition-shadow duration-200 rounded shadow-xl group hover:shadow-2xl">
